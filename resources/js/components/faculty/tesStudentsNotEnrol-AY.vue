...
<div class="container-fluid">
      <v-app>
       ...
       <div v-if="isprint===false" id="non-printable1">
           <h3 class="title text-center">TES STUDENTS NOT ENROLLED</h3>
                            ...
                            <div class="row">
                                ...
                                <v-data-table 
                                          ...
                                          <template v-slot:item.action="{ item }"> 
                                                 ...
                                                 <v-tooltip top color="indigo">
                                                        <template v-slot:activator="{ on, attrs }">
                                                                    <v-btn
                                                                          ...
                                                                          @click="showUploadModal(item.StudID)"
                                                                        fab
                                                                        small
                                                                        class="ma-2"
                                                                        color="indigo"
                                                ...
                                                <span v-if="item.loa != null">   
                                                    <v-tooltip top color="pink">
                                                        <template v-slot:activator="{ on, attrs }">
                                                    <v-btn
                                                         @click="getfront(item.loa)"
                                                        fab
                                                        small
                                                        color="pink"
                                                        class="ma-2"
...
<!-- 
            ...
            <Modal id="non-printable1" v-model="showviewModal">
                     <p slot="header" style="color:#1E88E5;text-align:center">
                                ...
                                <span>Upload Leave of Absence</span>
                            </p>
                            ...
                            <div slot="footer" >
                                <Button type="default" size="large"   @click.prevent="uploadLoa" >UPLOAD</Button>
                            </div>
...
<script>
    ...
    export default {
            ...
            return {
                ...
                index:'',
                 ...
                 headers: [
                        ...
                        { text: 'TES Award #', value: 'tesAwardNo' ,align: 'center',width: 150,},
                        ...
                        { text: '', value: 'loa', align: ' d-none'},
                     
                        { text: 'LOA', value: 'action',align: 'center', },
     ...
     methods:{
         ...
         showUploadModal(StudID){
             
             this.loaStud = StudID
            // if (this.schlEdit.modStatus===1){
         ...
         async uploadLoa(){
               let formData = new FormData();
                formData.append('StudID', this.loaStud);
                
                formData.append('loa', this.loa);

                
                const res = await this.callApi('post', 'app/uploadLoa', formData)
                    if(res.status===200){
                                  ...
                                  this.showviewModal = false
                                    this.isAdding=false
                                        ...
                                        hasIcon: true,
                                        message: 'LOA successfully Uploaded!',
                                        confirmText: 'OK',
                                    })
                                    this.loa=''
        ...
        TES3bform(){
         ...
         tesNotEnrol(){
             return ("TES-Not Enrol(" + this.TermNum + ")" + ".xls");
         },
        ...
        async gettesStud(){
            const res = await  axios.get('/api/getTesStudentsNotEnrol/' + this.TermNum)
            if(res.status==200){
                if(res.data.length===0){
                    // console.log('sdsd')
                    this.$Loading.error();
